    ...
    >
      <div className="px-6 md:px-16 lg:px-24 h-16 flex items-center justify-between">
        ...
        <a href="#" className="flex items-center gap-3 group">
          <img src="/logo-simbolo.svg" alt="mb" className="h-7 w-auto" />
          <img src="/logo-wordmark.svg" alt="marcelle breciani" className="h-4 w-auto opacity-80 group-hover:opacity-100 transition-opacity" />
        </a>
